...
func main() {
	...
	db_connection := "user=postgres dbname=chicago_business_intelligence password=root host=chicago-business-intelligencee:us-central1:mypostgres sslmode=disable"
